...
#evaluationSet="FDDB"
evaluationSet="multi_pie_rebuttal"
...
if [ "$evaluationSet" == "videoData_baidu" ]  
  ...
  testImgList=${evaluationDataDir}"video_data_list"
  testImgDir=${evaluationDataDir}"data/"
  testImgGroundTruth=${evaluationDataDir}"supervisory_control_data_Rect_2.txt"     # need to be generated by Bin He
  detectionRes=${evaluationDataDir}"supervisory_control_data_Rect_predict_with_iou03.res"            # given by sdk 
  evaluationRes=${evaluationDataDir}"supervisory_control_data_Rect_evaluation_with_iou03_new.res" # output
  needDetectAgain=0
  overlapThreshold=0.3
  needSaveRes=1
  is_rotated_gt="0"
  saveDir=${evaluationDataDir}"supervisory_control_data_Rect_with_iou03_new/"
fi

if [ "$evaluationSet" == "multi_pie_rebuttal" ]  
  then
  evaluationDataDir="/home/vis/tangxu/multi-pie/tangxu_use/"
  testImgList=${evaluationDataDir}"multi_pie_3pose.txt"
  testImgDir=${evaluationDataDir}
  dstDir="/home/vis/tangxu/multi-pie/tangxu_use_crop_400/"
  failedList=${evaluationDataDir}"multi_pie_3pose_failed_list"
fi


./bin/gen_refimage_pts $testImgList $testImgDir $dstDir $failedList
